...
#define array(T) _TOKENPASTE(_array_, T)
#define array_push(T) _TOKENPASTE(_array_push_, T)
#define array_insert(T) _TOKENPASTE(_array_insert_, T)
#define array_search(T) _TOKENPASTE(_array_search_, T)
#define array_delete(T) _TOKENPASTE(_array_delete_, T)
#define array_free(T) _TOKENPASTE(_array_free_, T)
#define _array_grow(T) _TOKENPASTE(_array_grow_, T)
#define array_alloc(T) _TOKENPASTE(_array_alloc_, T)
#define _array_shrink(T) _TOKENPASTE(_array_shrink_, T)
#define array_clear(T) _TOKENPASTE(_array_clear, T)
